...
public class CharacterStats : MonoBehaviour
{
    ...
    public Stat critPower;  //default value 150% of base;
    ...
    public virtual void DoDamage(CharacterStats _targetStats)
    {
        ...
        DoMagicalDamage(_targetStats);//remove when you don't want apply magic damage on your primary attack
    }
    ...
    protected int CalculateCriticalDamage(int _damagee)
    {
        float totalCritPower=((critPower.GetValue()+strength.GetValue())*.01f);
        float critDamage = _damagee * totalCritPower;
